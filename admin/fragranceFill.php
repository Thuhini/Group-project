...
<?php
  ...
  $sql = "SELECT * FROM fragrance WHERE ItemCode='$id'";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <br>
      <a type="button" id="myBtn" class="button3" href="fragrance.php" style="margin-left:25px;background-color: #ee4e0d;">Back</a>

            <form action="action/updateFragrance.php" method="post" enctype="multipart/form-data">
              <div class="container">
                <div class="container signin">
                  <center>
                    <h1>Update Fragrance Item</h1>
                ...
                <center>
                    ...
                    <br>
                    <input type="text" placeholder="Enter Code" name="ItemCode" value="<?php echo $ic ?>" readonly>
                    <br>
                    <label for="ItemName"><b>Item Name</b></label>
                    <br>
                    <input type="text" placeholder="Enter Name" name="ItemName" value="<?php echo $in ?>" required>
                    <br>
