...
<?php
  ...
  $sql = "SELECT * FROM bathandbody WHERE ItemCode='$id'";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <br>
      <a type="button" id="myBtn" class="button3" href="body.php" style="margin-left:25px;background-color: #ee4e0d;">Back</a>

            <form action="action/updatebody.php" method="post" enctype="multipart/form-data">
              <div class="container">
                <div class="container signin">
                  <center>
                    <h1>Update Bath & Body Item</h1>
